...
@interface CCScannerViewController ()<CCAlertViewDelegate>
...
- (void)setUpCamera{
    ...
    @catch (NSException *exception) {
        ...
        CCAlertView * alertView = [[CCAlertView alloc]initWithTitle:@"提示" message:@"请在设备的 设置-隐私-相机 中允许访问相机。" delegate:self cancelButtonTitle:@"设置" otherButtonTitles:titlesArr];
        ...
        if ([current.type isEqualToString:AVMetadataObjectTypeQRCode]) {
            ...
            if([current isKindOfClass:[AVMetadataMachineReadableCodeObject class]]) {
                ...
                if ([scannedValue trim].length != 0) {
                    ...
                    CCScannerDetailController * detailView = [[CCScannerDetailController alloc]init];
