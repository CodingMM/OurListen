...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    YYLoginResponse *login = [YYLoginResponse sharedYYLoginResponse];
    nameL.text = login.name;
    if ([YYLoginResponse sharedYYLoginResponse].accountInfo) {
        [self setAttributesWithJSONObject:[YYLoginResponse sharedYYLoginResponse].accountInfo];
    }else {
        
        [self getCurrentUserInfo];
    }
    
    if ([YYLoginResponse sharedYYLoginResponse].logoImage) {
        self.logoImage = [YYLoginResponse sharedYYLoginResponse].logoImage;
    }else {
        self.logoImage = [UIImage imageNamed:@"people-icon"];
...
{
    /*
    YYSetViewController *setViewController = [[YYSetViewController alloc]init];
    [[SliderViewController sharedSliderController] closeSideBarWithAnimate:YES complete:^(BOOL finished){
        [[SliderViewController sharedSliderController].navigationController pushViewController:setViewController animated:YES];
    }];
     */
}
